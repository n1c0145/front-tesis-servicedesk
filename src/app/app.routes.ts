...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'users-list', component: UsersListComponent, canActivate: [authGuard], data: { roles: [1] } },
      { path: 'manage-profile/:id', component: ManageProfileComponent, canActivate: [authGuard], data: { roles: [1] } },
